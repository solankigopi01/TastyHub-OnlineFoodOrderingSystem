...
public class AdminController {
	...
	@Autowired
	private AdminMgmtServiceImpl adminServices;
	@Autowired
	private ProductMgmtServiceImpl productServices;	
	@Autowired
	private OrderMgmtServiceImpl orderServices;
	...
	public String returnBack(Model model)
	{
		...
		List<Admin>admins=this.adminServices.getAllAdmins(); 
	...
	{
		this.adminServices.updateAdminById(admin, id);
		return "redirect:/admin/services";
	}
